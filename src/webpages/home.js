        ...
        return result.map((element) => {
            return (
                <tr>
                    ...
                    <td>{element.data.isPublic !== null && element.data.isPublic !== undefined ? element.data.isPublic.toString(): 'null'}</td>
                    <td>{element.data.ipVersion}</td>
                    <td>{element.data.isWhitelisted !== null && element.data.isWhitelisted !== undefined ? element.data.isWhitelisted.toString(): 'null'}</td>
